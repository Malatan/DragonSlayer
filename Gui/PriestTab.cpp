...
void PriestTab::initButtons() {
    float width = 300.f;
    float height = 40.f;
    this->restoreHpBtn = new gui::Button(
    ...
    this->restoreMpBtn = new gui::Button(
    ...
    this->removeAllDebuffsBtn = new gui::Button(
            this->restoreHpBtn->getPosition().x,
    ...
    this->recoverAllBtn = new gui::Button(
            this->restoreHpBtn->getPosition().x,
...
PriestTab::~PriestTab() {
    delete this->restoreHpBtn;
    delete this->restoreMpBtn;
    delete this->removeAllDebuffsBtn;
    delete this->recoverAllBtn;
}
